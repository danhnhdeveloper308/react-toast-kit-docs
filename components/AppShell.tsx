...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    const applyTheme = () => {
      const isDark = saved === 'dark' || (saved === 'system' && colorScheme.matches);
    ...
    applyTheme();
    if (saved === 'system') colorScheme.addEventListener('change', applyTheme);
  ...
  return (
    <ToastProvider theme={theme} position="top-right">
      <div
        className="site-shell min-h-screen flex flex-col text-slate-900 dark:text-slate-100 transition-colors duration-200"
      ...
      >
        ...
        <header
          className={`sticky top-0 z-40 w-full transition-all duration-200 ${
            scrolled
              ? 'border-b border-slate-200/80 dark:border-slate-800/80 bg-white/80 dark:bg-slate-950/75 backdrop-blur-xl shadow-sm'
              : 'border-b border-transparent bg-white/55 dark:bg-slate-950/35 backdrop-blur-lg'
          }`}
        >
              ...
              <Link href="/" className="flex items-center gap-2.5 group flex-shrink-0">
                ...
                <div className="flex flex-col leading-none">
                  ...
                  <span className="text-[10px] font-medium text-slate-400 dark:text-slate-500 tracking-wider">
                    v{siteConfig.version} · Modern toast UI
                  </span>
                </div>
              </Link>
              ...
              <nav className="max-w-7xl mx-auto px-4 py-3 flex flex-col gap-0.5">
                ...
                <div className="flex items-center gap-3 px-3 pt-3 pb-1 border-t border-slate-100 dark:border-slate-800 mt-1">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-sm text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 flex items-center gap-1.5"
                  >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 mb-10">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                  A modern, performant, and accessible toast notification library for React
                  applications.
                </p>
              ...
              <div>
                ...
                <ul className="space-y-2.5">
                  {[
                    ...
                    {
                      label: 'Report Issues',
                      href: 'https://github.com/danhnhdeveloper308/react-toast-kit/issues',
                    },
                    {
                      label: 'Changelog',
                      href: 'https://github.com/danhnhdeveloper308/react-toast-kit/releases',
                    },
                    {
                      label: 'MIT License',
                      href: 'https://github.com/danhnhdeveloper308/react-toast-kit/blob/main/LICENSE',
                    },
                  ].map((link) => (
                    <li key={link.href}>
                      <a
