...
export default function AccessibilityPage() {
  ...
  const showLongContentToast = () => {
    toast({
      ...
      description:
        'This toast contains longer content to demonstrate how screen readers interpret more detailed notifications. The content is structured to be meaningful when read aloud.',
      duration: 8000,
      dismissible: true,
    });
  };
  ...
  const showActionToast = () => {
    toast.custom(
      <div className="p-4 bg-blue-600 rounded-lg">
        ...
        <p className="text-white/80 mb-3 text-sm">Would you like to proceed with this action?</p>
    ...
    toast.custom(
      <div className="p-4 focus-within:ring-2 focus-within:ring-blue-400">
        ...
        <p className="text-sm mb-3">
          This toast contains interactive elements with proper focus management.
        </p>
  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="mb-10">
        <h1 className="text-4xl font-bold mb-2 text-gray-900 dark:text-white">Accessibility</h1>
        <p className="text-lg text-gray-600 dark:text-gray-300">
          React Toast Kit is built with accessibility in mind, ensuring notifications are usable by
          everyone, including people using screen readers and keyboard navigation.
        </p>
      </div>
  ...
  <YourApp />
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg mb-8 p-6">
        ...
        <p className="mb-6 text-gray-600 dark:text-gray-300">
          Try these examples with a screen reader enabled or navigate with your keyboard to
          experience the accessibility features.
        </p>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg mb-8 p-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <ul className="list-disc list-inside mt-2 text-gray-600 dark:text-gray-300 space-y-1">
              <li>
                <strong>Tab</strong>: Move focus to the toast
              </li>
              <li>
                <strong>Enter/Space</strong>: Dismiss the toast when focused (if dismissible)
              </li>
              <li>
                <strong>Escape</strong>: Dismiss all toasts
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">
              React Toast Kit uses a visually hidden ARIA live region to announce toast messages to
              screen readers without interrupting focus. This ensures that users are notified of
              important information regardless of their current focus position.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">
              ...
              <code className="bg-gray-100 dark:bg-gray-700 px-1 py-0.5 rounded mx-1">
        ...
        <div className="space-y-6">
          <div>
            ...
            <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2">
              <li>
                Use meaningful titles and descriptions that provide context when read by screen
                readers
              </li>
              <li>Keep toast messages concise and focused on a single piece of information</li>
              <li>
                Use appropriate toast variants (success, error, etc.) to convey the right semantic
                meaning
              </li>
              <li>Consider using longer durations for toasts with more content</li>
              <li>
                Ensure custom toast components include proper keyboard navigation and focus
                management
              </li>
            </ul>
          </div>
      ...
      <div className="text-center mt-12 mb-8">
        ...
        <div className="flex gap-3">
          <a
            ...
            className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 text-sm transition-colors"
          >
            ARIA Alert Pattern
